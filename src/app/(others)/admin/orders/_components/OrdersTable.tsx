        ...
        <tbody className="divide-y divide-gray-200 bg-white">
          {orders.map((order) => (
            <tr key={order.id} className="align-top">
                    ...
                    <div key={`${it.id}-${idx}`} className="flex items-center gap-3">
                      <div className="relative w-12 h-12 border border-gray-200 flex-shrink-0 overflow-hidden">
                        {it.productVariant?.images?.[0]?.url ? (
                          <Image
                            ...
                            alt={it.productVariant.images[0].alt || it.productVariant.title}
                            fill
                            sizes="64px"
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-600 mt-1">
                          ...
                          {Number(it.productVariant?.price || 0).toLocaleString()} × {it.quantity} =
              ...
              <Td>
                <Button className="text-nowrap" size="sm" onClick={() => onView(order)}>
                  View Order
                </Button>
              </Td>
            </tr>
