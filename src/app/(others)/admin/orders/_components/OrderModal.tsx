...
import { useUpdateOrder } from "@/modules/orders/hooks";
import { Order } from "@/modules/orders/types";
import { PaymentStatusBadge } from "@/shared/components/Badge";
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Items */}
        <section>
          <h4 className="text-base font-semibold text-primary-500 mb-3">Items</h4>
            ...
            {order.items.map((it) => (
              <div key={it.id} className="flex items-center gap-4 p-3 text-sm">
                <div className="w-14 h-14 relative border border-gray-200 shrink-0">
                  <Image
                    src={it.productVariant?.images?.[0]?.url || "/placeholder-image.jpg"}
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-medium truncate">{it.productVariant?.title}</div>
                ...
                <div className="text-right shrink-0">
                  <div className="font-semibold">
                    ...
                    {Number((it.productVariant?.price || 0) * it.quantity).toLocaleString()}
                  </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          <section>
            <h4 className="text-base font-semibold text-primary-500 mb-3">Order Status</h4>
            <select
              value={status}
          ...
          <section>
            <h4 className="text-base font-semibold text-primary-500 mb-3">Customer Info</h4>
          ...
          <section>
            <h4 className="text-base font-semibold text-primary-500 mb-3">Billing Address</h4>
            <div className="space-y-2">
