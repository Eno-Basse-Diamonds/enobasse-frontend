...
export function CollectionsMultiSelect({
  ...
  return (
    <div ref={containerRef} className="relative">
      <label className="block text-sm font-semibold text-primary-400 mb-2">Collections *</label>
      ...
      >
        ...
        {selectedItems.length === 0 && <span className="text-gray-400">Select collections...</span>}
