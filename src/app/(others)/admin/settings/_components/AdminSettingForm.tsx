import { Globe, Save, Shield, User } from "lucide-react";

import type { Account, BillingAddress } from "@/modules/admin/types";
...
interface AdminSettingsFormProps {
  ...
  onBillingAddressChange: (field: keyof AdminEditFormData["billingAddress"], value: string) => void;
  onSave: () => void;
  onCancel: () => void;
  isSaving: boolean;
}
