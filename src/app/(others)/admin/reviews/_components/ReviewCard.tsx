...
import { Barcode, Calendar, ShieldCheck, ShieldOff, Star, Trash2, User } from "lucide-react";
        ...
        <div className="flex-grow">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
            <div className="flex items-center">
              ...
              <div>
                <h4 className="font-semibold text-primary-500">{review.authorName}</h4>
            ...
            <div
              className={`px-2 py-1 text-xs font-semibold whitespace-nowrap ${
                review.isVerified ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
              }`}
            >
              {review.isVerified ? (
        ...
        <div className="mt-auto">
          ...
          <div className="flex space-x-3 w-full">
            <Button
              ...
              leadingIcon={review.isVerified ? <ShieldOff /> : <ShieldCheck />}
