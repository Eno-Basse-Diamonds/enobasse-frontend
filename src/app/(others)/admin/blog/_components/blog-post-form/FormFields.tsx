...
import { FormErrors } from "@/modules/blog/api";
...
export const FormFields = ({
  ...
  >
    <div className="space-y-6">
      ...
      <ImageUploadField formData={formData} errors={errors} onImageChange={onImageChange} />
...
export const FormField: React.FC<FormFieldProps> = ({
  ...
  <div className="block">
    <label className="block text-sm font-semibold text-primary-400 mb-2">{label}</label>
    <input
      type="text"
      name={name}
      value={value}
...
export const ImageUploadField = ({ formData, errors, onImageChange }: ImageUploadFieldProps) => (
  <div className="image-upload">
    <label className="block text-sm font-semibold text-primary-400 mb-2">Featured Image *</label>
...
export const StatusField: React.FC<StatusFieldProps> = ({ isPublished, onChange, error }) => (
