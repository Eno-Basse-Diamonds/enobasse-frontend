...
import { FormState } from "@/modules/blog/api";
import { useCreateBlogPost, useUpdateBlogPost } from "@/modules/blog/hooks";
import { BlogPostFormData } from "@/modules/blog/schemas";
import { BlogPost } from "@/modules/blog/types";
import { Button } from "@/shared/components/Button";
import { textToSlug } from "@/shared/utils/string";

import { AlertMessage } from "./blog-post-form/AlertMessage";
import { FormFields } from "./blog-post-form/FormFields";
import { PreviewSection } from "./blog-post-form/PreviewSection";
    ...
    <>
      ...
      <AdminModal
        ...
        customHeader={
          <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-primary-500/10 bg-gray-50 shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" variant="ghost" onClick={onClose} className="rounded-full w-8 h-8">
        ...
        footer={
          <div className="flex items-center justify-end gap-3">
            ...
            <Button type="submit" loading={mutation.isPending} disabled={!isFormValid}>
      ...
      >
        <form onSubmit={handleSubmit} className="flex-1 flex overflow-hidden -mx-4 sm:-mx-6">
          ...
          {showPreview && (
            <PreviewSection adminName={session?.user?.name || ""} formData={formData} />
          )}
        </form>
      </AdminModal>
    </>
