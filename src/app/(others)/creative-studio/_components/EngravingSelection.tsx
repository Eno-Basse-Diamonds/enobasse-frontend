    ...
    <SectionContainer activeTab={activeTab} tabType="engraving" title="Engraving">
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-2">Maximum {MAX_CHARS} characters</p>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <button
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-sm text-left flex justify-between items-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
