...
export const ItemDetailsForm = ({ formData, errors, onInputChange }: ItemDetailsFormProps) => {
        ...
        <div className="p-4 py-8 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {errors?.metalType && <p className="text-red-500 text-sm mt-1">{errors.metalType}</p>}
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Karat *</label>
              <div className="relative">
                <select
                  required
              ...
              {errors?.karat && <p className="text-red-500 text-sm mt-1">{errors.karat}</p>}
            </div>
          </div>
        </div>
      </div>
