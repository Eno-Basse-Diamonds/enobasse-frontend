...
export const DesignSpecsForm = ({ designSpecs, errors, onInputChange }: DesignSpecsFormProps) => {
  const jewelryTypes = ["Ring", "Necklace", "Earrings", "Bracelet", "Pendant"];

  const metalTypes = ["Yellow Gold", "White Gold", "Rose Gold", "Platinum", "None"];
  ...
  return (
    <div className="bg-white border border-primary-100 shadow-md p-4 py-8 md:p-8 mb-8 rounded-sm">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-2">Jewelry Type *</label>
          ...
          {errors.jewelryType && <p className="mt-1 text-sm text-red-500">{errors.jewelryType}</p>}
        </div>
        ...
        <div>
          ...
          {errors.metalType && <p className="mt-1 text-sm text-red-500">{errors.metalType}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium text-slate-700 mb-2">Metal Purity *</label>
          <div className="relative">
            <select
          ...
          {errors.metalPurity && <p className="mt-1 text-sm text-red-500">{errors.metalPurity}</p>}
        </div>
        ...
        <div>
          ...
          {errors.gemstone && <p className="mt-1 text-sm text-red-500">{errors.gemstone}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium text-slate-700 mb-2">Size (Optional)</label>
          <input
            type="text"
        ...
        <div>
          ...
          {errors.occasion && <p className="mt-1 text-sm text-red-500">{errors.occasion}</p>}
        </div>
