...
export const RelatedPosts = ({ posts }: RelatedPostsProps) => {
  return (
    <section className="mt-16">
      <h2 className="text-2xl font-primary text-primary-500 mb-6">Related Blogs</h2>
      ...
      <article className="flex flex-col sm:flex-row gap-4 transition-colors">
        ...
        <div className="flex flex-col justify-between w-full">
          <div>
            ...
            <p className="mt-1 text-sm text-primary-400 line-clamp-2">{post.excerpt}</p>
          </div>
          <div className="mt-3 flex items-center justify-between">
            ...
            <span className="text-xs font-medium text-secondary-500">{post.readingTime} mins</span>
          </div>
        </div>
      </article>
    </Link>
