    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-primary-400 leading-relaxed">
          Your questions or feedback are always welcome at Eno Bassé. Join in a conversation with
          one of our Diamond and Jewelry Consultants to help you make the right decision.
        </p>
      </div>

      <div className="space-y-6">
        <div className="flex items-start space-x-4">
          <MapPin strokeWidth={1.5} className="w-6 h-6 text-primary-200 flex-shrink-0 mt-1" />
          <Link
          ...
          >
            <p className="text-primary-500 font-medium">Admiralty Mall, Lekki Phase 1</p>
            <p className="text-primary-400">Lekki, Lagos</p>
          </Link>
        </div>

        <div className="flex items-start space-x-4">
          <Phone strokeWidth={1.5} className="w-6 h-6 text-primary-200 flex-shrink-0 mt-2" />
        ...
        <div className="flex items-center space-x-4">
          <Mail strokeWidth={1.5} className="w-6 h-6 text-primary-200 flex-shrink-0" />
          <Link
