...
import { sendMessage } from "@/modules/contact/api";
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-[99999] backdrop-blur-sm">
          <div className="rounded-sm bg-white p-6 max-w-md w-full">
            <div className="text-center">
              <CircleCheck strokeWidth={1.5} className="mx-auto h-12 w-12 text-green-500" />
...
const InputField: React.FC<InputFieldProps> = ({
  ...
  return (
    <div>
      <label htmlFor={id} className="block text-sm font-medium text-primary-500 mb-2">
        {label}
      </label>
      {rows ? (
        <textarea
