...
import { ChevronDownIcon, ChevronUpIcon, Loader2, User } from "lucide-react";
...
export function CheckoutAuthSection({ onAuthSuccess }: CheckoutAuthSectionProps) {
    ...
    <div className="bg-white shadow rounded-sm mb-6 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-[#502B3A]">Have an account?</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {authMode === "sign-up" && (
              <div className="flex items-start">
                ...
                <label htmlFor="checkout-terms" className="ml-2 block text-xs text-gray-500">
                  I agree to the{" "}
                  <Link
