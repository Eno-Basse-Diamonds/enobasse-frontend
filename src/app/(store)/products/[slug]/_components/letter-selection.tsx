    ...
    <div className="mb-6 space-y-3">
      <div className="flex justify-between items-center flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <label className="text-sm font-medium text-[#502B3A]">
            Selected Letters:
          </label>
          {selectedLetters.map((letter, index) => (
            <motion.div
              ...
              className={`
                ...
                ${
                  !isAvailable(letter)
                    ? "bg-[#D1A559] text-white"
                    : "bg-[#502B3A] text-white"
                }
              `}
            >
              <span>{letter}</span>
      ...
      {selectedLetters.some((l) => availability[l] === false) && (
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
        >
          Note: One or more selected items are out of stock. You can request
          this item.
        </motion.p>
      )}
    </div>
