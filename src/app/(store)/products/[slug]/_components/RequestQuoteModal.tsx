...
export const RequestQuoteModal: React.FC<RequestQuoteModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Failed to send quote request. Please try again.";
          ...
          >
            ...
            <div className="w-full md:w-3/5 bg-gray-50 p-8 flex-col justify-center items-center border-r border-gray-100 hidden md:flex">
              <div className="relative w-full aspect-square max-w-[300px] mb-6">
                <Image
                  src={variantImage || product.images[0]?.url || "/placeholder.png"}
                  alt={product.name}
                  fill
            ...
            <div className="w-full md:w-2/5 p-6 md:p-10 overflow-y-auto custom-scrollbar">
              <div className="mb-8">
                ...
                <p className="text-[#502B3A]/80 text-sm leading-relaxed max-w-2xl">
                  The majority of our pieces are custom made from top to bottom. We take great pride
                  in unique and exquisite designs. We can customize any piece to your specific taste
                  as well. Please fill out the form below and we will contact you right away with a
                  quote and time estimate. All items in our design gallery can be custom made to the
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        />
                        <span className="text-[#502B3A] text-sm font-medium">Email</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="radio"
                          ...
                          className="w-4 h-4 text-[#D1A559] focus:ring-[#D1A559] border-gray-300"
                        />
                        <span className="text-[#502B3A] text-sm font-medium">Phone</span>
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          className="w-4 h-4 text-[#D1A559] focus:ring-[#D1A559] border-gray-300"
                        />
                        <span className="text-[#502B3A] text-sm font-medium">Natural Diamonds</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          type="radio"
                      ...
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input
                          ...
                          className="w-4 h-4 text-[#D1A559] focus:ring-[#D1A559] border-gray-300"
                        />
                        <span className="text-[#502B3A] text-sm font-medium">Both</span>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-[#D1A559] focus:ring-[#D1A559] border-gray-300"
                      />
                      <span className="text-[#502B3A] text-sm font-medium">USD ($)</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="radio"
                        ...
                        className="w-4 h-4 text-[#D1A559] focus:ring-[#D1A559] border-gray-300"
                      />
                      <span className="text-[#502B3A] text-sm font-medium">Naira (₦)</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="text-xs text-[#502B3A]/60 leading-relaxed">
                  Please note that this communication may be monitored or recorded by us or our
                  service providers. By selecting &quot;Send Message&quot; you agree to our{" "}
