...
import type { AccountFormValidationErrors, EditFormData } from "@/modules/account/types";
import type { Account } from "@/modules/admin/types";
...
export function AccountForm({
  ...
  const [validationErrors, setValidationErrors] = useState<AccountFormValidationErrors>({});
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-light text-primary-500">Personal Information</h2>
        {!isEditing && (
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-primary-500 font-light">{account?.phone || "Not provided"}</p>
            </div>
          </div>
