...
export function CollectionCard({ collection, index }: CollectionCardProps) {
  ...
  return (
    <Link href={`/collections/${collection.slug}`} className="group flex flex-col h-full">
      ...
      <div className="mt-4 flex flex-col flex-grow">
        <h3 className="text-base md:text-lg font-medium text-gray-900">{collection.name}</h3>
