 ...
 *
 * @description Fetches the current homepage settings.
 ...
 *
 * @description Updates homepage settings.
 * @param data - The homepage settings to update
...
/**
 * Uploads a hero video file.
 *
 * @description Uploads a raw video file to the backend processing endpoint.
 * The server converts it to WebM, extracts a poster frame, uploads all three
 * to Cloudinary, and returns the updated settings.
 * @param file - The video file to upload
 * @param optimize - Whether to optimise the video (default true)
 * @returns The updated homepage settings
 */
