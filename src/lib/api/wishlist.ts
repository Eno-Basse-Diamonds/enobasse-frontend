...
export const getWishlist = async (accountEmail: string): Promise<Wishlist> => {
  return api.get(`/wishlist`, { params: { accountEmail } });
};
...
export const removeFromWishlist = async (
  ...
  return api.delete(`/wishlist/${productVariantId}`, { params: { accountEmail } });
};
