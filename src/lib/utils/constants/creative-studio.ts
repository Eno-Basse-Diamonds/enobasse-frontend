...
export const headStylesByGemstone = {
  round: [
    "4-prong-nouveau",
    "classic-halo",
    "hidden-halo",
...
export const gemstonesByHeadStyle = {
  "4-prong-nouveau": [
    "round",
    "princess",
    "radiant",
...
export const metalTypes = [
  { id: "white-gold", name: "White Gold", color: "#dadada" },
  { id: "yellow-gold", name: "Yellow Gold", color: "#e9d9ab" },
  { id: "rose-gold", name: "Rose Gold", color: "#fce3d4" },
  { id: "platinum", name: "Platinum", color: "#e5e5e5" },
];
...
export const gemstone3DProperties = {
  ROUND: {
    position: [0.001, 9.5, 0.007],
    scale: 0.78,
  },
  PRINCESS: {
    position: [0.001, 9.4, 0.007],
...
export const shank3DProperties = {
  SOLITARE: {
    position: [0, -1.605, 0],
  ...
  "TWIST-PAVE": {
    position: [0.031, -0.9, 0],
  },
};

export const head3DProperties = {
  "4-PRONG-NOUVEAU": {
    ROUND: {
      position: [0, 0.7, 0],
      scale: 0.95,
