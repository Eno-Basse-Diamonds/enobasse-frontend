 ...
 *
 * @description Displays a slide-up banner informing users about cookie usage.
 * Provides "Accept All" and "Necessary Cookies Only" buttons. The user's choice
 * is persisted in localStorage so the banner only appears once. Animates in
 * after a 1-second delay and animates out on dismissal.
 *
 * @returns A consent banner or null if already consented.
 */
        ...
        >
          <div>
            ...
            <p className="text-white text-sm leading-relaxed mb-4 font-light">
              ...
              traffic, and personalize content. By continuing to browse, you consent to our use of
              cookies.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="rounded-sm px-4 py-2 border border-white text-white font-medium text-sm tracking-wide sm:flex-1 hover:bg-white/10 transition-all duration-200"
              >
