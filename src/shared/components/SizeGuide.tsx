...
import { RING_SIZE_GUIDE } from "@/modules/services/constants";

/**
 * Ring size conversion table.
 *
 * @description Displays a full ring size conversion table with columns for USA,
 * France, UK/Australia, Germany/Russia, Italy/Spain/Netherlands, and
 * India/China/Japan sizing. Data is sourced from the RING_SIZE_GUIDE constant.
 *
 * @returns A scrollable conversion table.
 */
        ...
        <div className="mx-auto max-w-3xl bg-white">
          <div className="p-6 text-center">
            ...
            <p className="mt-2 text-xs text-gray-500">
              Should you require any assistance finding your ring size, please contact us.
            </p>
          </div>
        </div>
              ...
              <table className="w-full border-collapse text-xs">
                <thead>
                  <tr className="sticky top-0 bg-primary-500 text-white">
                    ...
                    <th className="border border-gray-300 p-2">ITA / ESP / NED</th>
                    <th className="border border-gray-300 p-2">IND / CHN / JAP</th>
                  </tr>
                </thead>
                <tbody>
                  {RING_SIZE_GUIDE.map((row, index) => (
