 ...
 *
 * @description Renders a horizontally scrollable carousel with previous/next
 * buttons, touch and mouse drag/swipe support, and dot indicators. Items are
 * displayed in pages determined by itemsPerPage. Loops from last page back to
 * the first. Accessible with ARIA live region and tab controls.
 *
 * @param items - Array of carousel items with image, title, and link.
 * @param itemsPerPage - Number of items visible per slide (default 4).
 * @param ariaLabel - Accessible label for the carousel region.
 * @param className - Additional CSS classes.
 * @returns A navigable image carousel.
 */
          ...
          {items.map((item, index) => (
            ...
            >
              <Link href={item.href} passHref>
                <div className="cursor-pointer block" draggable="false">
